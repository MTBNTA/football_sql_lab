...
-- SELECT name FROM divisions WHERE contry = 'Scotland';
```
...
SELECT COUNT(DISTINCT id) FROM matches WHERE division_code = 'N1' AND ftr = 'D' AND season <= 2015 AND season >= 2010;
